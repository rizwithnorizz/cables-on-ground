...
export default function ReservationsList() {
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      // Check if there are any other reservations for this drum
      const { data: otherReservations, error: checkErr } = await supabase
        .from("reservation")
        .select("id")
        .eq("drum_id", itemToDelete.drumId)
        .limit(1);

      if (checkErr) throw checkErr;

      // If no other reservations exist, update reserved to false
  ...
  return (
    <div className="p-8 mx-auto">
      <ConfirmationModal
        ...
        title="Delete Reservation Item"
        message="Are you sure you want to delete this reservation item? This action cannot be undone."
        confirmText="Delete"
        cancelText="Cancel"
      ...
      {/* Filters */}
      <div className="space-y-4 dark:bg-[#111827]/80 border dark:border-[#0047FF]/30 rounded-3xl p-8 shadow-lg shadow-[#0047FF]/10 mb-6">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          <div className="space-y-2">
            ...
            <Input
              ...
              className="dark:bg-[#0b1220] dark:border-[#0047FF]/30 dark:text-white"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full rounded-md border dark:border-[#0047FF]/30 dark:bg-[#0b1220] px-3 py-2 dark:text-white"
            />
          </div>
      ...
      <div className="space-y-4">
        {groupedReservations.length === 0 ? (
          <div className="text-center dark:text-gray-400 py-8 dark:bg-[#111827]/80 border dark:border-[#0047FF]/30 rounded-3xl p-8">
          ...
          groupedReservations.map((group) => (
            <div
              ...
              className="dark:bg-[#111827]/80 border dark:border-[#0047FF]/30 rounded-3xl p-6 shadow-lg shadow-[#0047FF]/10"
            >
